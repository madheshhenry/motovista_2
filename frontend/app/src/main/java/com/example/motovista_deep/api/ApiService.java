...
public interface ApiService {
    ...
    Call<LoginResponse> adminVerifyOtp(@Body OtpRequest request);
    ...
    @POST("admin_reset_password.php")
    Call<GenericResponse> adminResetPassword(@Body ResetPasswordRequest request);
