...
public class AdminDocumentsActivity extends AppCompatActivity {
    ...
    private void initializeViews() {
        ...
        // Set initial alpha for animations - Set to 1f (visible) since animation is removed
        cardBillReceipt.setAlpha(1f);
        cardDeliveryNote.setAlpha(1f);
        btnFinishOrder.setAlpha(1f);
