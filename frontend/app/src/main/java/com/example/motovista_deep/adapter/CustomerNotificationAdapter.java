...
import com.example.motovista_deep.EmiDetailsActivity;
import com.example.motovista_deep.OrderStatusActivity;
import com.example.motovista_deep.OrderSummaryActivity;
...
public class CustomerNotificationAdapter extends RecyclerView.Adapter<CustomerNotificationAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v -> {
            ...
            String id = notification.getItem_id();

            if (screen != null) {
                Intent intent = null;
                if ("OrderStatusActivity".equals(screen)) {
