...
public class CustomerProfileScreenActivity extends AppCompatActivity {
    ...
    private void initializeViews() {
        ...
        // Prime
        CardView btnJoinPrime = findViewById(R.id.btnJoinPrime);
        if (btnJoinPrime != null) {
            btnJoinPrime.setOnClickListener(v -> {
            ...
            public void onResponse(Call<GetProfileResponse> call, Response<GetProfileResponse> response) {
                ...
                if (response.isSuccessful() && response.body() != null) {
                    if (!response.body().isSuccess()) {
                        com.example.motovista_deep.utils.AuthHelper.handleAuthFailure(CustomerProfileScreenActivity.this, response.body().message);
                        return;
                    }
                    ...
                    if (com.example.motovista_deep.utils.AuthHelper.handleAuthFailure(CustomerProfileScreenActivity.this, response.code(), response.message())) {
                        return;
                    }
    ...
    private void setupClickListeners() {
        ...
        // Settings Section
        if (btnNotifications != null && switchNotifications != null) {
            // Initialize Switch State
            switchNotifications.setChecked(SharedPrefManager.getInstance(this).areNotificationsEnabled());

            // Switch Listener
            switchNotifications.setOnCheckedChangeListener((buttonView, isChecked) -> {
                SharedPrefManager.getInstance(this).setNotificationsEnabled(isChecked);
